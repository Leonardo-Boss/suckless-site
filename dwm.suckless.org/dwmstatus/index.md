...
* [pinky-bar](https://github.com/wifiextender/pinky-bar) - Display overall usage about: cpu and cpu temperature, ram, disk, installed packages, kernel, voltage, system fans and their speed in RPM, motherboard (name, vendor, temperature), volume, time, the name of currently played song, network throughput, upload and download speed, disk I/O.
